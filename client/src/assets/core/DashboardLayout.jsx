...
const DashboardLayout = () => {
    ...
    const navLinks = [
        ...
        { to: '/growth', label: 'Growth', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7 20h10"></path><path d="M10 20c5.5-2.5 8-9 8-14"></path><path d="M6 14c1 2 3.5 3.5 6.5 3.5"></path><path d="M18 6c-3 0-6 1-8 4"></path><path d="M12 10c-2-3-6-4-8-4"></path><path d="M4 6c0 5 2.5 11.5 8 14"></path></svg> },
    ];
